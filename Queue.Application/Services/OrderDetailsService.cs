...
{
    public class OrderDetailsService : BaseService<OrderDetils,OrderDetilsResponseModel,OrderDetilsRequestModel>, IOrderDetilsService
    {
        private readonly IRepository<OrderDetails> orderDetilsRepository;
        ...
        public OrderDetailsService(IRepository<OrderDetils> orderDetilsRepository, IRepository<Worker> workerRepository, IRepository<Service> serviceRepository, IRepository<Client> clientRepository, IMapper mapper)
        {
